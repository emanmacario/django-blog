...
SECRET_KEY = '*_8%r3--fg!$xjd1i4duu!!b4b9x0ifn^q^w8)zr&h(8qqwyj!'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Full path to root dir to store uploaded files
MEDIA_URL = '/media/'
...
# Use Boto 3 backend to interact with AWS S3
DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'

# AWS IAM user credentials for S3 storage
